...
const TABLE_HEAD = [
  ...
  { id: 'office_id', label: 'officename', alignRight: false },
...
export default function OnProgressRequest() {
  ...
  const request = [...Array(24)].map((_, index) => ({
    ...
    office_id: requestList.office_id,
    fullname: requestList.fullname,
